...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
			...
			if (zeroGravity)
			{
				m_RigidBody.velocity = Vector3.Lerp(m_RigidBody.velocity, Vector3.zero, Time.deltaTime * 2.5f);
			}
            m_Jump = false;
        }
        ...
        private float SlopeMultiplier()
        {
			...
			if (zeroGravity)
			{
				return movementSettings.zeroGravityCurveModifier.Evaluate(angle);
			}
			else
			{
